<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="iQHub.Login" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <table align="center">
                <tr>
                    <td style="width:100px"><br/><br/><asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" Width="80px" /></td>
