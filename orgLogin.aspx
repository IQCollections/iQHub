<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orgLogin.aspx.cs" Inherits="iQHub.orgLogin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <form id="form1">
            <div class="card">
                <h1 align="center">Organisation Login</h1>
                <br />
                <br />
                ...
                <div class="button">
                    <asp:Button ID="btnLogin" runat="server" Text="Login" align="center" OnClick="btnLogin_Click" Width="80px" />

                    <div class="btn-link">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/orgRegister.aspx">Register</asp:HyperLink>
                    </div>
                </div>
