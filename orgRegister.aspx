<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orgRegister.aspx.cs" Inherits="iQHub.orgRegister" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <form id="form1">
            <div class="card">
                <h1 align="center">Organisation Register</h1>
                <br />
                <br />
     ...
     <tr>
                ...
                <div class="button">
                    <asp:Button ID="btnRegister" runat="server" Text="Register" align="center" OnClick="btnRegister_Click" Width="80px" />

                    <div class="btn-link">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/orgLogin.aspx">Login</asp:HyperLink>
                    </div>
                </div>
